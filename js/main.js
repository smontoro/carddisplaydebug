...
// array for card
var deck = new Array //dont understand how this equals 52
...
function newCard(suit, value) {
  ...
  this.cardInfo = function() {
    return alerts('This card is the ' + this.value + ' of ' + this.name)
  }
};
...
function displayCard() {
  ...
  // remove the currecnt card from the deck array
